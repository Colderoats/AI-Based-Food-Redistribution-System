...
UPDATE surplus_food SET status = COALESCE(status, 'Available');
ALTER TABLE ngo_request ALTER COLUMN request_status SET DEFAULT 'Pending';
UPDATE ngo_request SET request_status = COALESCE(request_status, 'Pending');
ALTER TABLE donation ALTER COLUMN donation_status SET DEFAULT 'Approved';
UPDATE donation SET donation_status = COALESCE(donation_status, 'Approved');
